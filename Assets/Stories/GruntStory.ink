...
* [Hello?] -> Talk
+ [A sane person does not talk to grey cylinders] -> Walkaway
...
=== Grunt ===
Unexpectedly, there's a low guttural sound that builds and builds until it seems to vibrate the entire cylinder. And then it stops.
-> END

=== Walkaway ===
Yeah, no, lets not do this.
-> END