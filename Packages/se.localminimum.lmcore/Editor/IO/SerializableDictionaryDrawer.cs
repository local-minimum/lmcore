...
namespace LMCore.IO
{
    ...
    public class GenericSerializableDictionaryDrawer<TKey, TValue> : PropertyDrawer
    {
        ...
        bool KeyPropertyEquals(SerializedProperty property, TKey value)
        {
            ...
            {
                return property.objectReferenceValue == (value as ScriptableObject);
            }
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            for (var i = 0; i < keys.arraySize; i++)
            {
                ...
                if (typeof(TKey).IsSubclassOf(typeof(ScriptableObject)))
                {
                    EditorGUI.BeginDisabledGroup(true);
                    EditorGUI.ObjectField(keyRect, "", key.objectReferenceValue, typeof(TKey), true);
