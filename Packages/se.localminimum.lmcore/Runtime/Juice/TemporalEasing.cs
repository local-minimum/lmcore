...
namespace LMCore.Juice
{
    ...
    public class TemporalEasing<T>
    {
        ...
        /// <summary>
        /// Time when easing started
        /// </summary>
        float easeStart;
        public bool IsEasing { get; private set; } = false;

        /// <summary>
        /// Progress (x-axis) of easing animation curve where easing started
        /// </summary>
        float progressStart;
        /// <summary>
        /// Progress (x-axis) of easing animation curve where easing ends
        /// </summary>
        float progressEnd;
        /// <summary>
        /// Time that the animation should take
        /// </summary>
        float duration;
        ...
        public bool Paused
        {
            ...
            set
            {
                ...
                {
                    easeStart += Time.timeSinceLevelLoad - pauseStart;
                }
                _Paused = value;
            }
        }
        ...
        private float TimeProgress =>
            Paused ?
            Mathf.Clamp01((pauseStart - easeStart) / duration) :
            Mathf.Clamp01((Time.timeSinceLevelLoad - easeStart) / duration);
