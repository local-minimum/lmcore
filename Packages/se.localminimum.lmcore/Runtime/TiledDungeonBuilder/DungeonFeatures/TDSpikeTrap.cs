...
namespace LMCore.TiledDungeon.DungeonFeatures
{
    ...
    public class TDSpikeTrap : TDFeature, IOnLoadSave
    {
        ...
        float _NextPhaseTime;
        float NextPhaseTime
        {
            get => Paused ? _NextPhaseTime + Time.timeSinceLevelLoad - _PauseStart : _NextPhaseTime;
            set
            {
                _NextPhaseTime = value;
            }
        }
        bool _Paused;
        float _PauseStart;
        bool Paused
        {
            ...
            set
            {
                ...
                {
                    _NextPhaseTime += Time.timeSinceLevelLoad - _PauseStart;
        ...
        public void PushEntity()
        {
            ...
            foreach (var occupant in Node.Occupants)
            {
                ...
                occupant.InjectForcedMovement(movement);
            }
        }
